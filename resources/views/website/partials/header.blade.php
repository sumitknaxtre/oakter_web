<header class="site-header">
  ...
  <nav class="primary-nav" aria-label="Primary navigation">
    <a href="{{ route('website.home') }}" @if (request()->routeIs('website.home', 'website.new_home', 'website.buy_studio_ac', 'website.legacy.collections.mini_ac', 'website.legacy.products.studio_ac', 'website.legacy.blogs.news', 'website.legacy.pages.warranty_policy')) aria-current="page" @endif>Studio AC</a>
