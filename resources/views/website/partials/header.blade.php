<header class="site-header">
  ...
  <nav class="primary-nav" aria-label="Primary navigation">
    ...
    <a href="{{ route('website.mini_ups') }}" @if (request()->routeIs('website.mini_ups', 'website.buy_mini_ups', 'website.buy_mini_ups_airfiber', 'website.legacy.products.mini_ups_pro', 'website.legacy.products.mini_ups_airfiber', 'website.legacy.mini_ups_airfiber')) aria-current="page" @endif>Mini UPS</a>
